    ...
    <div class="sidebar custom-sidebar">
      ...
      " class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <router-link :to="{ name: 'woocommerce' }" class="nav-link">
                  <i class="nav-icon fas fa-download" />
                  <p>{{ $t("sidebar.woocommerce") }}</p>
                </router-link>
              </li>
              <li class="nav-item">
                <router-link :to="{ name: 'woocommerce.syncLog' }" class="nav-link">
                  <i class="nav-icon fas fa-download" />
                  <p>{{ $t("sidebar.sync_log") }}</p>
                </router-link>
              </li>
              <li class="nav-item">
                <router-link :to="{ name: 'woocommerce.settings' }" class="nav-link">
                  <i class="nav-icon fas fas fa-cogs" />
                  <p>{{ $t("woocommerce.settings") }}</p>
                </router-link>
              </li>
            </ul>
          </li> -->
          ...
          <li v-if="$can('database-backup')" class="nav-item">
            <a href="https://docs.codeshaper.tech/acculance/#section-changelog" class="nav-link" target="__blank">
