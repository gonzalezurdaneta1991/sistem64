        ...
        <div class="card custom-card w-100">
          <div class="card-header setings-header">
            <div class="col-xl-4 col-4">
              <h3 class="card-title">
                {{ $t("inventory.non_zero.page_title") }}
              </h3>
            </div>
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <a
                  href="/non-zero-inventory/pdf"
                  v-tooltip="$t('common.export_pdf')"
...
export default {
  ...
  metaInfo() {
    return { title: this.$t("inventory.non_zero.page_title") };
  },
  data: () => ({
    breadcrumbsCurrent: "inventory.non_zero.breadcrumbs_current",
    breadcrumbs: [
      {
        name: "inventory.non_zero.breadcrumbs_first",
        url: "home",
      },
      {
        name: "inventory.non_zero.breadcrumbs_second",
        url: "products.index",
      },
      {
        name: "inventory.non_zero.breadcrumbs_active",
        url: "",
      },
    ],
    query: "",
  ...
  computed: {
    ...
    exportUrl() {
      ...
      return `/non-zero-inventory/export/excel?term=${this.query}`;
    },
  },
  watch: {
    // watch search data
  ...
  methods: {
    ...
    async getData() {
      ...
      await this.$store.dispatch("operations/fetchData", {
        path: "/api/non-zero-inventory?page=",
    ...
    async searchData() {
      ...
      await this.$store.dispatch("operations/searchData", {
        path: "/api/non-zero-inventory/search",
        term: this.query,
        currentPage: currentPage + "&perPage=" + this.perPage,
      });
    },
